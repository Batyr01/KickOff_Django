...
urlpatterns = [
    ...
    path('players/', cache_page(60)(ShowPlayers.as_view()), name='players'),

    # Clubs
    path('clubs/', cache_page(60)(ShowClubs.as_view()), name='clubs'),
    path('club/<slug:club_slug>/', ShowClub.as_view(), name='club'),
    path('<slug:league_slug>/clubs/', LeagueClubs.as_view(), name='league_clubs'),

    # Leagues
    path('leagues/', cache_page(60)(ShowLeagues.as_view()), name='leagues'),
